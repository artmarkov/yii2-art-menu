...
{
    public $modelClass = 'artsoft\models\Menu';
    public $modelSearchClass = 'artsoft\menu\models\search\SearchMenu';
    public $modelLinkSearchClass = 'artsoft\menu\models\search\SearchMenuLink';
